...
//           List<Pair> pair = new ArrayList<>();
           ...
           for (int j = 0; j < x; j++) {
               ...
               int ci = fs.nextInt();
               ci--;
//               pair.add(new Pair(wi, ci));

               q[ci] = (q[ci]% MOD + (q[c]%MOD * wi%MOD)%MOD )%MOD;
           }
//           a.add(new P(c, pair));
...
//       Collections.sort(a, (P x, P y) -> {
//           return x.c - y.c;
//       });
//
//       for (int i = 0; i < a.size(); i++) {
//           int c = a.get(i).c;
//           for (int j = 0; j < a.get(i).list.size(); j++) {
//               int wi = a.get(i).list.get(j).a;
//               int ci = a.get(i).list.get(j).b;
//               q[ci] = (q[ci]% MOD + (q[c]%MOD * wi%MOD)%MOD )%MOD;
//           }
//           q[c] = 0;
//       }
